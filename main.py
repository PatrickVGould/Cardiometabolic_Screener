...
st.write("<h4 style='margin-bottom: 0;'>Demographics</h4>", unsafe_allow_html=True)
st.write("<hr style='margin-top: 0; border: none; height: 1px; background-color: black;'>", unsafe_allow_html=True)
